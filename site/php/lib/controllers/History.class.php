...
class History
{
	public function render($request)
	{
		...
		$this->addSection($view, '2012 April', 'Took part in my first <a href="//www.ludumdare.com/compo/">Ludum Dare Competition</a> and released my first entry Miniature Worlds, which ended up with over 50,000 downloads on the Google Play store. This started me on a path of releasing mini-games on a regular basis and built up my confidence with my tools and release processes. The rest of my Ludum Dare entries can be found from <a href="//ludumdare.com/compo/author/markavian/">my profile on the Ludum Dare website</a>.');
		...
		$this->addSection($view, '2008', 'DFMA - Dwarf Fortress Map Archive took off in a big way. Thousands of visits a day and hundreds of maps and movies uploaded every month as the <a href="//mkv25.net/dfma/recentactivity.php">stats pages</a> reveal.');
		$this->addSection($view, '2007 May', '<a href="//mkv25.net/dfma/">The Dwarf Fortress Map Archive</a> (DFMA) was launched in support of the #bay12game classic Dwarf Fortress. ' . "Its launch heralded a new era in map-sharing and epic fortress building that would allow players to share unbelievable constructions of immense size with relative ease. Made possible by my FDF-Map Viewer software (written using Flash AS3), in partnership with ShadowLord's Map Compressor software, the site is truely innovative - if I may say so myself.");
		...
		$this->addSection($view, '2002 October', 'The website <a href="//tfc.mkv25.net/">The Fake Clan</a> - a Worms Armageddon (pc game) fansite for maps and team members was launched. The map archived featured a shopping cart and PHP Zipping system for downloading batches of maps from the site in a convenient download. All of the maps were designed by me and gained popularity amongst pro-ropers around the net- some of them I consider works of art.');
		...
		$this->addSection($view, '2002 April', 'The website <a href="//mkv25.net/USy/">Universal Shipyards</a>, built around Space Empires IV graphics and modding, which was previously hosted on Tripod and other places for the previous 3 years, was finally moved to my new server. The site was already handling thousands of visits a day which eventually dwindled as the game aged. USy was my first site, and a major hobby, leading me to learn programming, webdesign, and 3D graphics.');
